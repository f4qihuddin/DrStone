...
CREATE TABLE `batu` (
  ...
  `idSubKategoriBatu` varchar(100) NOT NULL
...
CREATE TABLE `bookmark` (
  `idBookmark` varchar(100) NOT NULL,
...
CREATE TABLE `data_mini_game` (
  `idDataMiniGame` varchar(100) NOT NULL,
...
CREATE TABLE `kategori` (
  `idKategoriBatu` varchar(100) NOT NULL,
...
CREATE TABLE `sesi_mini_game` (
  `idSesiMiniGame` varchar(100) NOT NULL,
...
(UUID(), 'Batuan Metamorf Tindihan', '3'),
(UUID(), 'Batuan Sedimen Klastika', '1'),
(UUID(), 'Batuan Tubir', '2'),
(UUID(), 'Batuan Metamorf Kontak', '3'),
(UUID(), 'Batuan Sedimen Kimiawi', '1'),
(UUID(), 'Batuan Leleran', '2'),
(UUID(), 'Batuan Metamorf Regional', '3'),
(UUID(), 'Batuan Sedimen Biokimia', '1'),
(UUID(), 'Batuan Korok', '2');
